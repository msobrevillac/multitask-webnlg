...
from constants import WEBNLG_TOKENS
import sacrebleu
import os
...
def main(args):
	...
	for ast in WEBNLG_TOKENS:
		if ast not in tokenizer.get_added_vocab():
			tokenizer.add_tokens([ast])

	train_set = WebnlgDataset(df_train, tokenizer, args.src_max_length, args.tgt_max_length)
	dev_set = WebnlgDataset(df_dev, tokenizer, args.src_max_length, args.tgt_max_length)
	test_set = WebnlgDataset(df_test, tokenizer, args.src_max_length, args.tgt_max_length)
